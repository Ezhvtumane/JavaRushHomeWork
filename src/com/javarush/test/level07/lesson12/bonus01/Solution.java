...
public class Solution
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        while (true)
        {
            ...
            if(ages.isEmpty()){break;}else{age = Integer.parseInt(ages);}

            //System.out.print("Введите вес: ");
            int weight;
            String weights=reader.readLine();
            if(weights.isEmpty()){break;}else{weight = Integer.parseInt(weights);}

            //System.out.print("Введите рост: ");
            int tail;
            String tails=reader.readLine();
            if(tails.isEmpty()){break;}else{tail = Integer.parseInt(tails);}
